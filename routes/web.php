...
Route::group(['middleware'=>['web','Index']],function() {
    ...
    Route::get('/yongjin', 'IndexController@yongjin');
    ...
    Route::get('/cny_mingxi', 'IndexController@cny_mingxi');
});
...
Route::group(['middleware'=>['web','Admin']],function() {
    ...
    Route::get('/admin/sys/order/del', 'ProductController@sysOrderDel'); //订单管理
