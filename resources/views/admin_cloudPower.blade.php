    ...
    <div class="site-content">
        ...
        <div class="box box-block bg-white">
            <div class="form-group" style="height: auto; overflow: hidden;">
                <a href="{{url('admin/sys/cloudPower/add')}}" ><button type="button" class="  btn btn-primary w-min-sm m-b-1 waves-effect waves-light" style="float: right;display:inline-block" >添加产品</button></a>
            </div>
            <table class="table table-striped table-bordered dataTable" id="tab" >
                ...
                @foreach($data as $v)
                    <tr>
                        <td>{{$v->id}}</td>
                        <td>{{$v->name}}&nbsp;<span class="tag tag-success top">{{$v->Cloud->name}}</span>&nbsp;<span class="tag tag-info top">{{$v->ProductModel->name}}</span></td>
                        <td>{{$v->power}}</td>
        ...
        <div class="modal-dialog" role="document" style="max-width: 1000px;">
            <div class="modal-content">
                <div class="modal-body" style="background: #fff">
                    ...
                    <div class="form-group h-a" style="text-align: center">
                        <label for="name" class=" col-form-label label200" >云算力：</label>
                        <div  style="float:left; width: 250px;">
                    ...
                    <div class="form-group h-a" style="text-align: center">
                        <label for="name" class=" col-form-label label200" >算力大小：</label>
                        <div  style="float:left; width: 250px;">
                            <input class="form-control" type="text" name="name"  value="" id="ajaxPower" readonly>
                        </div>
                    </div>
                    <div class="form-group h-a" style="text-align: center">
                        <label for="name" class=" col-form-label label200" >预计日收益：</label>
                        <div  style="float:left; width: 250px;">
