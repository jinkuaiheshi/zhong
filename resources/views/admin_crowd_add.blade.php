...
@section('content')
    ...
    <div class="site-content">
        ...
        <div class="box box-block bg-white">
            ...
            <div class="row">
                <form class="form-horizontal " method="post" enctype="multipart/form-data" action="{{url('/admin/sys/crowd/add')}}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group h-a" style="text-align: center">
                        ...
                        <div class="col-md-1">
                            <div   class="form-group">
                                <input type="number" placeholder="" class="form-control" name="price" readonly value="2100" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group h-a" style="text-align: center">
