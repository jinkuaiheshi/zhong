...
<head>
    ...
    <!-- swiper -->
    <link rel="stylesheet" href="{{asset('resources/assets/css/swiper.min.css')}}">
    <script src="{{asset('resources/assets/js/swiper.min.js')}}"></script>
...
<footer class="footer-fixed">
    <div class="van-tabbar-item">
        ...
        <div class="van-tabbar-item-top">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-shop" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="font-size: 24px;">
    ...
    <div class="van-tabbar-item">
        ...
        <div class="van-tabbar-item-top">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-gift" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="font-size: 24px;">
    ...
    <div class="van-tabbar-item">
        <a href="javascript:void(0)" style="width: 100%; display: inline-block; color: #666;text-align: center">
        <div class="van-tabbar-item-top">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-book" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="font-size: 24px;">
    ...
    <div class="van-tabbar-item">
        ...
        <div class="van-tabbar-item-top">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="font-size: 24px;">
