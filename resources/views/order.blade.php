...
{{--        </div>--}}
        ...
        <div class="order_line">
            ...
            <div class="order_right">
                <input type="text" value="@if($data->attr == 1 && $data->model == 1){{'630'*Session::get('car')}}@elseif($data->attr == 1 && $data->model == 2){{'50.4'*Session::get('car')}}@elseif($data->attr == 1 && $data->model != 2 &&$data->model != 5){{'3780'*Session::get('car')}}@elseif($data->attr == 1 && $data->model == 5){{'300'}}@elseif($data->attr == 2 && $data->model == 1){{'1575'*Session::get('car')}}@elseif($data->attr == 2 && $data->model == 2){{'126'*Session::get('car')}}@elseif($data->attr == 2 && $data->model > 2  ){{'3780'*Session::get('car')}}@elseif($data->attr == 3 && $data->model == 1){{'3780'*Session::get('car')}}@elseif($data->attr == 3 && $data->model == 2){{'302.4'*Session::get('car')}}@elseif($data->attr == 3 && $data->model  > 2){{'3780'*Session::get('car')}}@endif"
