...
{{--        </div>--}}
        ...
        <div class="order_line">
            ...
            <div class="order_right">
                <input type="text" value="@if($data->attr == 1 && $data->model == 1){{'126'*Session::get('car')}}@elseif($data->attr == 1 && $data->model == 2){{'94.5'*Session::get('car')}}@elseif($data->attr == 1 && $data->model != 2 &&$data->model != 5){{'1260'*Session::get('car')}}@elseif($data->attr == 1 && $data->model == 5){{'300'}}@elseif($data->attr == 2 && $data->model == 1){{'264.6'*Session::get('car')}}@elseif($data->attr == 2 && $data->model == 2){{'226.8'*Session::get('car')}}@elseif($data->attr == 2 && $data->model != 2  && $data->model != 1){{'2646'*Session::get('car')}}@elseif($data->attr == 3 && $data->model == 1){{'554.4'*Session::get('car')}}@elseif($data->attr == 3 && $data->model == 2){{'504'*Session::get('car')}}@elseif($data->attr == 3 && $data->model != 2 && $data->model != 1){{'5544'*Session::get('car')}}@endif"
