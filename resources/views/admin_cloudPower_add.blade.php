...
@section('content')
    ...
    <div class="site-content">
        ...
        <div class="box box-block bg-white">
            ...
            <div class="row">
                <form class="form-horizontal " method="post" enctype="multipart/form-data" action="{{url('/admin/sys/cloudPower/add')}}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group h-a" style="text-align: center">
                        <div class="col-md-3" style="text-align: right">
                            <label for="order" class=" col-form-label " >算力产品：</label>
                        </div>
                        <div class="col-md-3">
                            <select class="form-control " name = 'cloud' required id="cloud" >
                    ...
                    <div class="form-group h-a" style="text-align: center">
                        <div class="col-md-3" style="text-align: right">
                            <label for="order" class=" col-form-label " >算力大小：</label>
                        </div>
                        <div class="col-md-3">
                            <div   class="form-group">
                                <input type="text" placeholder="" class="form-control" name="power"  value="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group h-a" style="text-align: center">
                        <div class="col-md-3" style="text-align: right">
                            <label for="order" class=" col-form-label " >预计日收益：</label>
                        </div>
                        <div class="col-md-3">
                            <div   class="form-group">
                    ...
                    <div class="form-group h-a" style="text-align: center">
                        ...
                        <div class="col-md-1">
                            <div   class="form-group">
                                <input type="number" placeholder="" class="form-control" name="price"  value="" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group h-a" style="text-align: center">
