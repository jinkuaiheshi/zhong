    ...
    <div class="site-content">
        ...
        <div class="box box-block bg-white">
            <div class="form-group" style="height: auto; overflow: hidden;">
                <a href="{{url('admin/sys/depository/add')}}" ><button type="button" class="  btn btn-primary w-min-sm m-b-1 waves-effect waves-light" style="float: right;display:inline-block" >添加产品</button></a>
            </div>
        ...
        <div class="modal-dialog" role="document" style="max-width: 1000px;">
            <div class="modal-content">
                <div class="modal-body" style="background: #fff">
                    ...
                    <div class="form-group h-a" style="text-align: center">
                        <label for="name" class=" col-form-label label200" >时限：</label>
                        <div  style="float:left; width: 250px;">
                    ...
                    <div class="form-group h-a" style="text-align: center">
                        <label for="name" class=" col-form-label label200" >电费：</label>
                        <div  style="float:left; width: 250px;">
